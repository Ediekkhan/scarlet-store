...
const Home: React.FC<HomeProps> = ({ products, addToCart }) => {
    ...
    <div >
        ...
        <img src={bgimg} className="w-full opacity-50" alt="background" />
        <div className="absolute top-2/3  transform  -translate-y-1/2 text-left text-white mx-10">
            <h3 className='text-2xl'>Explore trendy outfits</h3>
            <h1 className="text-8xl font-semibold">Mid year megasales</h1>
            <p className=" text-2xl mt-2 ">Get up to 30% discounts on tops</p>
        </div>
        </div>
        ...
        <section className="w-auto m-4">
            ...
            <div className="flex ">
                <div className="m-4 w-full md:w-1/2 lg:w-1/2 flex ">

                <div className="relative">
                <img src={full} alt="full" className="h- object-contain" />
                ...
                <div className="m-4  md:w-1/2 ">
                    ...
                    <div className="relative">
                        <img src={hal1} alt="hal1" className="h-[380px] w-screen mb-4" />
                        <div className="absolute bottom-4 left-4 text-left py-3 pr-20 pl-3 bg-white bg-opacity-75 text-black rounded">
                                <p className='text-gray-700'>NEW IN</p>
                            <h3 className=' text-black'>BODY CONS</h3>
                            <p className='underline text-[#D95F27] underline-offset-1'>show now</p>
                    ...
                    <div className="relative">
                        <img src={hal2} alt="hal2" className="h-[360px] w-svw" />
                        <div className="absolute bottom-4 left-4 text-left py-3 pr-20 pl-3 bg-white bg-opacity-75 text-black  rounded">
                                <p className='text-gray-700'>NEW IN</p>
                            <h3 className=' text-black'>BODY CONS</h3>
                            <p className='underline text-[#D95F27] underline-offset-1'>show now</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
          ...
          {products.slice(0, 6).map((product) => (
            <div key={product.id} className="border rounded-lg p-4 shadow-md">
              <img src={product.image} alt={product.name} className="h-[380px] w-full object-contain mb-4" />
